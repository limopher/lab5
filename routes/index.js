	...
	res.render('index', {
		'friends':[
			...
			{ 'name': 'Grace Hopper',
			  ...
			  'imageURL': 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Grace_Hopper.jpg/220px-Grace_Hopper.jpg'
			},
			{ 'name': 'Allen Newell',
			  'description': 'Really into psychology',
			  'imageURL': 'http://amturing.acm.org/images/lg_aw/3167755.jpg'
			}		
		  ] 
	});
};